...
use fib::{FibInteger, doubling, simple, uint::U256};
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    for n in max_indexes {
        if n <= <u8 as FibInteger>::max_fibonacci_index().unwrap() {
            ...
            c.bench_with_input(BenchmarkId::new("doubling::fib<u8>", n), &n, |b, &n| {
                b.iter(|| doubling::fib::<u8>(black_box(n)));
            });
        }
        if n <= <u16 as FibInteger>::max_fibonacci_index().unwrap() {
            ...
            c.bench_with_input(BenchmarkId::new("doubling::fib<u16>", n), &n, |b, &n| {
                b.iter(|| doubling::fib::<u16>(black_box(n)));
            });
        }
        if n <= <u32 as FibInteger>::max_fibonacci_index().unwrap() {
            ...
            c.bench_with_input(BenchmarkId::new("doubling::fib<u32>", n), &n, |b, &n| {
                b.iter(|| doubling::fib::<u32>(black_box(n)));
            });
        }
        if n <= <u64 as FibInteger>::max_fibonacci_index().unwrap() {
            ...
            c.bench_with_input(BenchmarkId::new("doubling::fib<u64>", n), &n, |b, &n| {
                b.iter(|| doubling::fib::<u64>(black_box(n)));
            });
        }
        if n <= <u128 as FibInteger>::max_fibonacci_index().unwrap() {
            ...
            c.bench_with_input(BenchmarkId::new("doubling::fib<u128>", n), &n, |b, &n| {
                b.iter(|| doubling::fib::<u128>(black_box(n)));
            });
        }
        ...
        c.bench_with_input(BenchmarkId::new("doubling::fib<U256>", n), &n, |b, &n| {
            b.iter(|| doubling::fib::<U256>(black_box(n)));
        });
    }
}
